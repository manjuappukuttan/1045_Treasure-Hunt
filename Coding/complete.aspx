<%@ Page Language="VB" AutoEventWireup="false" CodeFile="complete.aspx.vb" Inherits="complete" %>
...
<div id="main_container">
    ...
    <div id="center_content">
         ...
         <table style="padding:320px 0 0 140px;  font-size:52px; color:orange">
         <tr style="height:100px;">
         <td style="width:200px;"> <h1 style="font-size:46px; color:orange;">SCORE </h1> </td>
